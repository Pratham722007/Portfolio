...
export default function ContactSection() {
    return (
        <section id="contact" className="py-24 bg-primary relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-10 bg-black skew-y-1"></div>
            <div className="absolute bottom-0 left-0 w-full h-10 bg-black -skew-y-1"></div>
                        ...
                        <div>
                            <form className="space-y-4">
                                <div>
                                    ...
                                    <input type="text" className="w-full bg-gray-100 border-2 border-black p-3 rounded focus:bg-white focus:shadow-[4px_4px_0px_#FD0809] transition-all outline-none" placeholder="Your Name" />
                                </div>
                                <div>
                                    <label className="block text-xl font-bold mb-2">Email</label>
                                    <input type="email" className="w-full bg-gray-100 border-2 border-black p-3 rounded focus:bg-white focus:shadow-[4px_4px_0px_#FD0809] transition-all outline-none" placeholder="your@email.com" />
                                </div>
                                <div>
                                    <label className="block text-xl font-bold mb-2">Message</label>
                                    <textarea rows={4} className="w-full bg-gray-100 border-2 border-black p-3 rounded focus:bg-white focus:shadow-[4px_4px_0px_#FD0809] transition-all outline-none" placeholder="What's on your mind?"></textarea>
                                </div>
